...
def getWordScore(word, n):
    ...
    #For each letter in word. Take the value and add it together to get the base score.
    for letter in word:
        score += SCRABBLE_LETTER_VALUES[letter]
    
    #Multiply the base score by the length of the word to get the score.  
    score *= len(word)
    
    #If the word contains all the letters provided, add 50
    if len(word) == n:
        score += 50
    return score
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print(guess + " earned " + str(getWordScore(guess, n)) + " Points. Total: " + str(getWordScore(guess, n)) + " points")
                # Update the hand
